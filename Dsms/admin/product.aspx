<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product.aspx.cs" Inherits="Dsms.admin.product" %>
        ...
        <div class="row">
                <div >
                    ...
                    <br />
                        ...
                        <asp:Label ID="Label1" runat="server" Text="Products" Font-Bold="True" Font-Italic="False" Font-Names="Calibri" Font-Size="XX-Large"></asp:Label>&nbsp;
                </div>
                <br />
            <br />
                    <asp:GridView ID="GridView1" runat="server" Height="185px" Width="1134px" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="pid" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" BorderColor="#507CD1" BorderStyle="Dotted" CssClass="auto-style1" style="margin-left: 365px; margin-top: 26px;">
